          ...
          <div className="flex-1 overflow-y-auto py-6">
            <div className="px-4 mb-6">
              ...
              <ul className="space-y-2">
                ...
                {/* KPIs module - Only visible for T1 company users */}
                {user && user.company === "T1" && (
                  <li>
                    <Link
                      href="/kpis"
                      className={`flex items-center w-full px-3 py-2.5 rounded-lg transition-all duration-200 ${
            ...
            {/* Administration section - Only visible for T1 company users */}
            {sidebarOpen && user && user.company === "T1" && (
              <div className="px-4 mb-6">
                <h3 className="px-3 text-xs font-semibold text-[var(--gray-500)] uppercase tracking-wider mb-3">
                  Administración
                </h3>
